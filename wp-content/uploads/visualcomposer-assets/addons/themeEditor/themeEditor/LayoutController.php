...
class LayoutController extends Container implements Module
{
    ...
    {
        $globalTemplatePartData['header'] = vcapp('\themeEditor\themeEditor\LayoutController')->getGlobalTemplatePartData('header');
        $globalTemplatePartData['footer'] = vcapp('\themeEditor\themeEditor\LayoutController')->getGlobalTemplatePartData('footer');
    ...
    protected function addLayoutCss(
        ...
        if ($requestHelper->input('vcv-template-type', '') === 'vc-theme') {
            ...
            if (
                !empty($currentTemplate) && is_array($currentTemplate)
    ...
    protected function getPageEditableTemplatePartData($templatePart, Request $requestHelper)
    {
        ...
        if (
            ($footerId === 'default' && $headerId === 'default')
